//
//  NAFavouriteArticleCollectionView.swift
//  NewsApp
//
...
final class NAFavouriteArticleCollectionView: UICollectionViewCell {

    static let cellIdentifier = "NAFavouriteArticleCollectionViewCell"
    ...
    public func configure(with viewModel: NAFavouriteArticlesCellViewViewModel) {
